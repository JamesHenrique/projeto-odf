...
# sp(3)
# screenshot = py.screenshot(r'C:\Users\Servidor\Documents\Project ODF\assets\alerta_dosagem.png',region=(510,426,250,20))#x,y,largura,altura
...
def alerta_dosagem():
    ...
    while tentativas != 3:
        try:
            button_location = py.locateOnScreen(r"C:\Users\Servidor\Documents\Project ODF\assets\alerta_dosagem.png", confidence=0.9) #alterar o confidence sempre que não achar
            if button_location:
                print('alerta_dosagem localizado')
                sp(2)
                py.press('tab')
                py.press('enter')
                return 'sim'
            ...
            # py.press('esc',presses=2)
            print('tentando localizar - alerta_dosagem')
            tentativas += 1
        sp(3)  # Espera 1 segundo antes de tentar novamente
    return 'nao'
